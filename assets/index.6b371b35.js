...
`,Ce=c.div`
    width: ${e=>e.width||"100%"};
`,q={nickname:"",questionAmount:5,difficulty:"easy",theme:""},W=P({name:"settings",initialState:q,reducers:{setNickname:(e,t)=>{e.nickname=t.payload},setQuestionAmount:(e,t)=>{const o=parseInt(t.payload,10);e.questionAmount=o>20?20:o},setDifficulty:(e,t)=>{e.difficulty=t.payload},setTheme:(e,t)=>{e.theme=parseInt(t.payload,10)},resetSettings:()=>q}}),{setNickname:Le,setQuestionAmount:M,setDifficulty:$e,resetSettings:Ne,setTheme:_e}=W.actions;var Re=W.reducer;function z({width:e,type:t="text",label:o}){const a=v(),r=b(({settings:s})=>t==="text"?s.nickname:s.questionAmount);return n(Ce,{width:e,children:l(Te,{children:[o,n(Ie,{value:r,onChange:{text:({target:s})=>{a(Le(s.value))},number:({target:s})=>{s.value>20?a(M(20)):a(M(s.value))}}[t],type:t,max:"20"})]})})}const Ae=c.select`
    background-color: white;
    font-size: 1.2rem;
    border-radius: 10px;
    height: 50px;
